    ...
    <div className="max-w-6xl mx-auto md:px-4">
      ...
      <div className="flex flex-col md:flex-row gap-8">
        ...
        <div className="md:w-1/2 flex flex-col gap-4 py-4 px-3 bg-[#F5F6F6] rounded-lg">
          ...
          <p className="font-semibold  text-sm text-gray-900">Description :</p>
            <span className="pl-1">{product.description}</span>
          </div>

          {/* DELIVERY INFO */}
          <div className="text-sm text-gray-700 space-y-1">
            <p><span className="font-semibold">Delivery:</span> 3–5 days</p>
            <p><span className="font-semibold">Return Policy:</span> 7-Day Replacement</p>
          </div>
